...
var Book = /*#__PURE__*/_createClass(function Book(id, title, autor, srcImg) {
...
$('form').on('submit', function (event) {
  ...
  var autor = $('#autorBook').val();
  var srcImg = $('#imgBook').val();
  var user = new _class.Book(index, title, autor, srcImg);
  var newCard = (0, _function.creatBook)(user.title, user.autor, user.srcImg, index);
  book.push(user);
  ...
  for (var _i = 0, _book = book; _i < _book.length; _i++) {
    var b = _book[_i];
    var _newCard = (0, _function.creatBook)(b.title, b.autor, b.srcImg, index);
    document.querySelector('#container-cards').append(_newCard);
  }
  document.querySelector('form').reset();
  var btns = document.querySelectorAll('.btn-card').forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var btnSelect = e.target.id;
      if (btnSelect == 'clearCard') {
        for (var _i2 = 0, _book2 = book; _i2 < _book2.length; _i2++) {
          var _b = _book2[_i2];
          if (_b.title == btn.closest('.card').id) {
            book.splice(_b.title, 1);
          }
        }
...
},{"./class":"class.js","./function":"function.js"}],"../../../Users/HB/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
